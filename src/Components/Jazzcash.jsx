...
function Jazzcash() {
  return (
    <>
      <div className="md:justify-end justify-center  md:items-start items-center rounded border bg-white flex md:w-[350px] max-w-full w-[255px] flex-col pb-12 mt-5 border-solid border-zinc-300 border-opacity-80 self-start">
  ...
  <div class="flex flex-wrap rounded-md p-5">
                                <label htmlFor="">Please enter your 13 digit NIC Number </label>

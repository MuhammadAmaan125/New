...
function Bill_Bank() {
  return (
    <>
        ...
        <div className="md:justify-end justify-center  md:items-start items-center rounded  bg-white flex md:w-[350px] max-w-full w-[255px] flex-col pb-12 border-solid  border-opacity-80 self-start">
                           
                        
                         
      
                            <div class="flex flex-wrap rounded-md mt-5">
                                <label htmlFor="">Select Transfer Method </label>
